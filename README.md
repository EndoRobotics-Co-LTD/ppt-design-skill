...
**Q0. ⚠️ 회사 공식 PPT인가요?** (가장 먼저)
- "**예 / 공식 자료**" → 사내 디자인 표준(폰트·색상·레이아웃) **100% 강제**. 다음 질문으로.
- "**아니오 / 개인 작업 / 임시 자료**" → **이 스킬을 사용하지 않습니다.** 사내 표준 우회, Claude가 일반 PPT 작성으로 전환.

> 💡 비공식 자료에까지 표준이 강제되면 답답할 수 있어요. 공식 자료의 일관성은 보장하면서 개인 작업의 자유도는 보존하기 위한 첫 게이트입니다.
